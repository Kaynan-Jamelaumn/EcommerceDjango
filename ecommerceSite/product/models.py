...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("ecommerce:product:category", kwargs={"category_id": self.id})
...
class SubCategory(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("ecommerce:product:subcategory",
                       kwargs={
...
class SubSubCategory(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("ecommerce:product:subsubcategory",
                       kwargs={
...
class ProductVariation(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("ecommerce:product:hate", kwargs={"product_id": self.id})
